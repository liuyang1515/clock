...
QString Date::getLunarDate(int year, int month, int day) {
    ...
    if (1 == day) {
        if (month < 1) {
            strDate = QString::fromLocal8Bit("闰") + QString::fromLocal8Bit(s_pchMonName[month * -1]);
            return strDate;
        }
...
QString Date::getLunarTime(int year)
{
    ...
    if (year > T_D_YAER) {
        ...
        strTime.append(QString::fromLocal8Bit("年"));
    }
...
QString Date::holiday(int month, int day)
{
    ...
    case 0x0405: strHoliday = QString::fromLocal8Bit("清明节"); break;
...
QString Date::lunarFestival(int month, int day) {
    ...
    QString strFestival = "";
    switch (temp) {
    case 0x0101: strFestival = QString::fromLocal8Bit("春节");  break;
    case 0x010F: strFestival = QString::fromLocal8Bit("元宵节"); break;
    case 0x0202: strFestival = QString::fromLocal8Bit("龙抬头"); break;
    case 0x0505: strFestival = QString::fromLocal8Bit("端午节"); break;
    case 0x0707: strFestival = QString::fromLocal8Bit("七夕节"); break;
    case 0x080F: strFestival = QString::fromLocal8Bit("中秋节"); break;
    case 0x0909: strFestival = QString::fromLocal8Bit("重阳节"); break;
    case 0x0C08: strFestival = QString::fromLocal8Bit("腊八节"); break;
    default: break;
    }
